...
kmByYearAndUrbanicity = read_csv(here"../../data/","countyBondPlusSAIPE.csv")
ggplot(kmByYearAndUrbanicity,mapping=aes(x=povertyR,y=moneyPct,size=total_pop,color=factor(year))) + geom_point() + facet_wrap(vars(urbanicity),ncol=2)
```
